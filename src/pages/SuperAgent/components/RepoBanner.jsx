...
const REPO_URL = 'https://github.com/your-org/gamepac-super-agent';

export function RepoBanner({ className }) {
  return (
    <a
      href={REPO_URL}
      target="_blank"
      rel="noopener noreferrer"
      aria-label={`View Gamepac Super Agent repository on GitHub`}
      className={cn(
    ...
    >
      ...
      <Separator
        ...
        aria-hidden="true"
      />
      <p className="text-sm font-medium text-foreground tracking-wide">Star on GitHub</p>
      <div className="flex items-center gap-1 text-foreground/80" role="status" aria-live="polite">
        <StarFilledIcon
