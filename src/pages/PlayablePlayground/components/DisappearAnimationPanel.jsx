...
const DisappearAnimationPanel = ({ config, isEnabled, onToggle, onChange }) => {
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h4 className="text-white text-lg font-medium">DISAPPEAR ANIMATION</h4>
      ...
      <div className="space-y-4">
        <div>
          <label className="text-white text-sm">Delay before disappear (ms)</label>
          <input
            type="number"
            value={config.delay}
...
export default DisappearAnimationPanel;
