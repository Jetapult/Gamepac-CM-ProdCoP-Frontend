...
const UACreativeAnalyser = () => {
  ...
  const [activeTab, setActiveTab] = useState(
    location.pathname.includes("brief-generator") ? "brief" : "analysis"
  );
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  UA Creative Analyser
                </h1>
                <p className="text-sm text-gray-500 mt-1">
                  Analyze creatives and generate optimized briefs with
                  storyboards
                </p>
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col">
              ...
              <nav className="flex space-x-8" aria-label="Tabs">
                <button
                  onClick={() => {
                    ...
                    navigate(`/ua-intelligence/analyse${ad_id ? `/${ad_id}` : ""}`);
                  }}
                ...
                <button
                  onClick={() => {
                    setActiveTab("brief");
                    navigate(`/ua-intelligence/brief-generator${ad_id ? `/${ad_id}` : ""}`);
                  }}
                  className={`relative py-4 px-1 text-sm font-medium transition-all duration-200 ${
                    activeTab === "brief"
                      ? "text-gray-900"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-500">
                    Use your creative analysis to generate compelling briefs and
                    visual storyboards
                  </span>
                </div>
                <button
          ...
          <div className="flex-1 overflow-auto">
            <div className="p-6">
              ...
              {activeTab === "brief" && (
                <BriefGenerator ad_id={ad_id} analysisData={analysisData} />
              )}
            </div>
          </div>
        </div>
