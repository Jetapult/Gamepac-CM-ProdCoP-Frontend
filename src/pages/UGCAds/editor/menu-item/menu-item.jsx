...
import { AiAvatars } from "./ai-avatars";
import { Scripts } from "./scripts";
import { GPTScriptWriterPopup } from "./gpt-script-generator";
...
const ActiveMenuItem = () => {
  ...
  if (activeMenuItem === "ai-avatars") {
    return <AiAvatars />;
  }
  if (activeMenuItem === "scripts") {
    return <Scripts />;
  }
  return null;
};
...
export const MenuItem = () => {
  const { gptScriptWriterPopup, setGptScriptWriterPopup } = useLayoutStore();
  return (
    <>
      <Container>
        <ActiveMenuItem />
      ...
      {gptScriptWriterPopup && (
        <GPTScriptWriterPopup
          gptScriptWriterPopup={gptScriptWriterPopup}
          setGptScriptWriterPopup={setGptScriptWriterPopup}
        />
      )}
    </>
  );
