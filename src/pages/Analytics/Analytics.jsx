...
const analytics = [
  {
    ...
    embed:
      "https://lookerstudio.google.com/embed/reporting/78d787cc-9871-4388-a8fe-45c45c9de36a/page/8r4qD",
  },
  {
    id: "2",
    name: "Economy",
    ...
    embed:
      "https://lookerstudio.google.com/embed/u/0/reporting/b08e7772-0424-40c0-87f4-3210e5711377/page/UeqrD",
  },
  {
    id: "3",
    name: "Acquisition",
    ...
    embed:
      "https://lookerstudio.google.com/embed/u/0/reporting/28f0edaa-17c4-41d0-b57e-39acb0cbde3f/page/p_bwfuduzjfd",
  },
  {
    id: "4",
    name: "Tech",
    ...
    embed:
      "https://lookerstudio.google.com/embed/u/0/reporting/b9f3fee3-9c98-4743-97fc-69aa0520b881/page/p_bwfuduzjfd",
  },
  {
    id: "5",
    name: "Engagement",
    ...
    embed:
      "https://lookerstudio.google.com/embed/u/0/reporting/c8877a93-6981-4e89-83f4-ba73b114e61a/page/UeqrD",
  },
];
const Analytics = () => {
  ...
  return (
    <div className="">
      ...
      <div className="flex items-center mx-6 border-b border-b-[#e5e5e5] mb-2">
        {analytics.map((item) => (
          <p
            className={`text-xl mr-6 cursor-pointer ${selectedAnalytics.id === item.id ? "text-black" : "text-gray-500"}`}
            key={item.id}
